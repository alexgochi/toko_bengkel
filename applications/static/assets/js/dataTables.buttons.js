  ...
  $.extend(Buttons.prototype, {
    ...
    _nodeToButton: function (node, buttons) {
      ...
      for (var i = 0, ien = buttons.length; i < ien; i++) {
        if (
          buttons[i].node === node ||
          $(buttons[i].node).children().eq(0).get(0) === node
        ) {
          return buttons[i];
        }
    ...
    _popover: function (content, hostButton, inOpts) {
      ...
      if (position === "absolute") {
        ...
        if (
          ...
          left =
            buttonPosition.left - popoverSizes.width + hostNode.outerWidth();
        }
        ...
        if (
          ...
          left =
            $(window).width() - popoverSizes.width - containerPosition.left;
        }
