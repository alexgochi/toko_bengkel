!(function (e, t) {
  ...
  return (function (n) {
    ...
    function (e, t, n) {
      ...
      function u(n) {
        return new Promise(function (t) {
          !(function e() {
            n && void 0 !== n.naturalWidth && 0 !== n.naturalWidth && n.complete
              ? t()
              : setTimeout(e, 500);
          })();
        });
    ...
    function (e, t, n) {
      ...
      (t.addWrapper = function (e, t) {
        ...
        (t.addHeader = function (e, t) {
          ...
          if (l(t.header)) n.innerHTML = t.header;
            ...
            r.appendChild(o),
              r.setAttribute("style", t.headerStyle),
              n.appendChild(r);
          }
      ...
      function l(e) {
        return new RegExp("<([A-Za-z][A-Za-z0-9]*)\\b[^>]*>(.*?)</\\1>").test(
          e
        );
      }
    },
      ...
      t.default = {
        init: function () {
          ...
          switch (void 0 === e ? "undefined" : i(e)) {
            ...
            case "object":
              ...
              (t.fallbackPrintable = t.base64
                ? "data:application/pdf;base64," + t.fallbackPrintable
                : t.fallbackPrintable),
              t))
                "printable" !== n &&
                  "fallbackPrintable" !== n &&
          ...
          if (
            ...
            -1 === p.indexOf(t.type.toLowerCase())
          )
            throw new Error(
          ...
          switch (
            ...
            "pdf" !== t.type &&
              ((o.srcdoc =
                "<html><head><title>" + t.documentTitle + "</title>"),
              t.css &&
              ...
              if (
                ...
                try {
                  if (
                    ...
                    !0 === t.onBrowserIncompatible())
                  )
                    window.open(t.fallbackPrintable, "_blank").focus(),
            ...
            (r.responseType = "arraybuffer"),
              r.addEventListener("load", function () {
                if (-1 === [200, 201].indexOf(r.status))
                  return (0, a.cleanUp)(e), void e.onError(r.statusText);
                l(e, t, r.response);
              }),
        ...
        print: function (e, t) {
          ...
          n
            ? ((e.printableElement = (function e(t, n) {
                ...
                try {
                  for (
                    var l, d = t.childNodes[Symbol.iterator]();
                    !(o = (l = d.next()).done);
                    o = !0
                  ) {
                    var u = l.value;
                ...
                n.scanStyles &&
                  1 === t.nodeType &&
                  r.setAttribute("style", (0, f.collectStyles)(t, n));
                switch (t.tagName) {
                  case "SELECT":
                    r.value = t.value;
                    break;
              ...
              e.header && (0, f.addHeader)(e.printableElement, e),
              i.default.send(e, t))
    ...
    function (e, t, n) {
      ...
      t.default = {
        print: function (t, e) {
          ...
          if ("boolean" != typeof t.repeatTableHeader)
            throw new Error(
          ...
          (t.properties = t.properties.map(function (e) {
            return {
              field:
                "object" === (void 0 === e ? "undefined" : o(e)) ? e.field : e,
              displayName:
                "object" === (void 0 === e ? "undefined" : o(e))
                  ? e.displayName
                  : e,
              columnSize:
                "object" === (void 0 === e ? "undefined" : o(e)) && e.columnSize
                  ? e.columnSize + ";"
