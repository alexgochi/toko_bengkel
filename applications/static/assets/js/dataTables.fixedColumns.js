  ...
  (function () {
    ...
    var FixedColumns = /** @class */ (function () {
      ...
      FixedColumns.prototype._destroy = function () {
        ...
        $$1(this.s.dt.table().node()).removeClass(
       ...
       */
      FixedColumns.prototype._fixColumn = function (
        idx,
        offset,
        side,
        header,
      ...
      FixedColumns.prototype._setKeyTableListener = function () {
        ...
        this.s.dt.on("key-focus.dt.dtfc", function (e, dt, cell) {
          ...
          var scroll = $$1(
            $$1(_this.s.dt.table().node()).closest("div.dt-scroll-body")
          );
          ...
          if (_this.c.end > 0) {
            ...
            var leftMost = $$1(
              _this.s.dt.column(numCols - _this.c.end).header()
            );
